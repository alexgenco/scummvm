...
Common::KeymapArray LoLEngine::initKeymaps() {
	...
	addKeymapAction(keyMap, "AT1", _("Attack 1"), Common::KeyState(Common::KEYCODE_F1), "F1", "JOY_X");
	addKeymapAction(keyMap, "AT2", _("Attack 2"), Common::KeyState(Common::KEYCODE_F2), "F2", "JOY_Y");
	addKeymapAction(keyMap, "AT3", _("Attack 3"), Common::KeyState(Common::KEYCODE_F3), "F3", "JOY_LEFT_SHOULDER");
